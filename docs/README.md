...
| 了解某项具体能力的机制与三端实现 | [WebSocket 能力与三端架构](./websocket-architecture.md) | 对应平台的 Manager/校验源码 |
...
6. [WebSocket 能力与三端架构](./websocket-architecture.md)：微信官方机制、已实现能力现状、三端统一的架构骨架与命名。
